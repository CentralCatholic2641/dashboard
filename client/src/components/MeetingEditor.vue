    ...
    <v-card-text>
      ...
      >
        ...
        <v-date-picker
          ...
          v-model="input.date"
          full-width
          @click:date="$refs.date_menu.save(input.date)"
          color="primary"
        ></v-date-picker>
      </v-menu>
      ...
      >
        ...
        <v-time-picker
          ...
          v-model="input.start"
          full-width
          @click:minute="$refs.start_time_menu.save(input.start)"
          format="24hr"
          color="primary"
        ></v-time-picker>
      </v-menu>
      ...
      >
        ...
        <v-time-picker
          ...
          v-model="input.end"
          full-width
          @click:minute="$refs.end_time_menu.save(input.end)"
          format="24hr"
          color="primary"
        ></v-time-picker>
      </v-menu>
