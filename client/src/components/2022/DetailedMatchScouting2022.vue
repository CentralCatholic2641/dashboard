        ...
        <thead>
          <tr>
            ...
            <th
              @click="
                $router.push(
                  `/events/${team.scoutingschedule.event.toUpperCase()}/schedule/${match.key
        ...
        <tbody>
          <tr>
            ...
            <td
              ...
              @click="
                $router.push(
                  `/events/${event.key}/scouting/match?match=${match.key
                    .substring(match.key.lastIndexOf('_') + 1)
                    .toUpperCase()}&team=${team.team_number}`
                )
              "
            >
              <span
          ...
          <tr>
            ...
            >
              <span
                :class="{
                  'green--text': match.alliances[
                    match.winning_alliance
                  ].team_keys.includes(`frc${team.team_number}`),
                  'red--text': !match.alliances[
                    match.winning_alliance
                  ].team_keys.includes(`frc${team.team_number}`),
                }"
              ...
              >
                {{
                  match.alliances[match.winning_alliance].team_keys.includes(
                    `frc${team.team_number}`
                  )
                    ? "W"
                    : "L"
