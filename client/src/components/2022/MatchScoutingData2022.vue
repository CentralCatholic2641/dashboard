			...
			<template v-slot:default>
				...
				<tbody>
					<tr>
						...
						<td @click="$router.push(`/events/${match.key.substring(0, match.key.indexOf('_')).toUpperCase()}/teams/${match.alliances.red.team_keys[0].substring(3)}`)" v-ripple style="cursor: pointer">
							{{ match.alliances.red.team_keys[0].substring(3) }}
						</td>
						<td @click="$router.push(`/events/${match.key.substring(0, match.key.indexOf('_')).toUpperCase()}/teams/${match.alliances.red.team_keys[1].substring(3)}`)" v-ripple style="cursor: pointer">
							{{ match.alliances.red.team_keys[1].substring(3) }}
						</td>
						<td @click="$router.push(`/events/${match.key.substring(0, match.key.indexOf('_')).toUpperCase()}/teams/${match.alliances.red.team_keys[2].substring(3)}`)" v-ripple style="cursor: pointer">
							{{ match.alliances.red.team_keys[2].substring(3) }}
						</td>
						<td @click="$router.push(`/events/${match.key.substring(0, match.key.indexOf('_')).toUpperCase()}/teams/${match.alliances.blue.team_keys[0].substring(3)}`)" v-ripple style="cursor: pointer">
							{{ match.alliances.blue.team_keys[0].substring(3) }}
						</td>
						<td @click="$router.push(`/events/${match.key.substring(0, match.key.indexOf('_')).toUpperCase()}/teams/${match.alliances.blue.team_keys[1].substring(3)}`)" v-ripple style="cursor: pointer">
							{{ match.alliances.blue.team_keys[1].substring(3) }}
						</td>
						<td @click="$router.push(`/events/${match.key.substring(0, match.key.indexOf('_')).toUpperCase()}/teams/${match.alliances.blue.team_keys[2].substring(3)}`)" v-ripple style="cursor: pointer">
	...
	export default {
		...
		methods: {
			refresh() {
				...
				this.$http.get(`/api/scouting/match/${this.match.key}`).then((response) => {
