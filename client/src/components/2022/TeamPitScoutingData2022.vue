<template>
  <v-card :style="visible ? 'flex-grow: 2' : ''">
    ...
    <v-card-text class="mt-0 pt-0 white--text" v-if="visible">
      <p
        class="grey--text mt-1 text-center font-italic"
        v-if="!team.pitscouting"
      >
          ...
          <v-col cols="12" md="6">
            ...
            <table>
              ...
              <tr>
                ...
                <td>
                  {{ team.pitscouting.auto.shootLow ? "Low " : ""
                  }}{{ team.pitscouting.auto.shootHigh ? "High" : "" }}
                </td>
              </tr>
              ...
              <tr>
                ...
                <td>
                  {{ team.pitscouting.auto.cargoFloor ? "Floor " : ""
                  }}{{ team.pitscouting.auto.cargoTerminal ? "Terminal " : ""
                  }}{{ team.pitscouting.auto.cargoPreload ? "Preload" : "" }}
                </td>
              </tr>
          ...
          <v-col cols="12" md="6">
            ...
            <table>
              <tr>
                ...
                <td>
                  {{ team.pitscouting.teleop.shootLow ? "Low " : ""
                  }}{{ team.pitscouting.teleop.shootHigh ? "High" : "" }}
                </td>
              </tr>
          ...
          <v-col cols="12" md="6">
            ...
            <table>
              <tr>
                ...
                <td>
                  {{ team.pitscouting.end.hangLow ? "Low " : ""
                  }}{{ team.pitscouting.end.hangMid ? "Mid " : ""
                  }}{{ team.pitscouting.end.hangHigh ? "High " : ""
                  }}{{ team.pitscouting.end.hangTraversal ? "Traversal" : "" }}
                </td>
              </tr>
            </table>
          </v-col>
        ...
        <v-row>
          <v-col cols="12" md="6">
            ...
            <v-btn
              ...
              color="grey"
              link
              :to="`/events/${$route.params.code}/scouting/pit?team=${$route.params.team}`"
