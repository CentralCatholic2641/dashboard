      ...
      <tbody>
        <tr>
          ...
          <td class="text-center">
            <v-icon>{{
              match.score_breakdown.red.taxiRobot1 == "Yes"
                ? "mdi-check"
                : "mdi-close"
            }}</v-icon>
            <v-icon>{{
              match.score_breakdown.red.taxiRobot2 == "Yes"
                ? "mdi-check"
                : "mdi-close"
            }}</v-icon>
            <v-icon>{{
              match.score_breakdown.red.taxiRobot3 == "Yes"
                ? "mdi-check"
                : "mdi-close"
            }}</v-icon>
          ...
          <td class="text-center">
            <v-icon>{{
              match.score_breakdown.blue.taxiRobot1 == "Yes"
                ? "mdi-check"
                : "mdi-close"
            }}</v-icon>
            <v-icon>{{
              match.score_breakdown.blue.taxiRobot2 == "Yes"
                ? "mdi-check"
                : "mdi-close"
            }}</v-icon>
            <v-icon>{{
              match.score_breakdown.blue.taxiRobot3 == "Yes"
                ? "mdi-check"
                : "mdi-close"
            }}</v-icon>
        ...
        <tr>
          ...
          <td class="text-center">
            <v-icon>{{
              match.score_breakdown.red.quintetAchieved
                ? "mdi-check"
                : "mdi-close"
            }}</v-icon>
          </td>
          <td class="text-center">
            <v-icon>{{
              match.score_breakdown.blue.quintetAchieved
                ? "mdi-check"
                : "mdi-close"
            }}</v-icon>
          </td>
        ...
        <tr>
          <td>Robot 1 End</td>
          <td class="text-center">
            <span v-if="match.score_breakdown.red.endgameRobot1 != 'None'">
              {{ match.score_breakdown.red.endgameRobot1 }} (+{{
                endgamePointMap[match.score_breakdown.red.endgameRobot1]
              }})
            </span>
            <v-icon v-else>mdi-close</v-icon>
          </td>
          <td class="text-center">
            <span v-if="match.score_breakdown.blue.endgameRobot1 != 'None'">
              {{ match.score_breakdown.blue.endgameRobot1 }} (+{{
                endgamePointMap[match.score_breakdown.blue.endgameRobot1]
              }})
            </span>
            <v-icon v-else>mdi-close</v-icon>
          </td>
        ...
        <tr>
          <td>Robot 2 End</td>
          <td class="text-center">
            <span v-if="match.score_breakdown.red.endgameRobot2 != 'None'">
              {{ match.score_breakdown.red.endgameRobot2 }} (+{{
                endgamePointMap[match.score_breakdown.red.endgameRobot2]
              }})
            </span>
            <v-icon v-else>mdi-close</v-icon>
          </td>
          <td class="text-center">
            <span v-if="match.score_breakdown.blue.endgameRobot2 != 'None'">
              {{ match.score_breakdown.blue.endgameRobot2 }} (+{{
                endgamePointMap[match.score_breakdown.blue.endgameRobot2]
              }})
            </span>
            <v-icon v-else>mdi-close</v-icon>
          </td>
        ...
        <tr>
          <td>Robot 3 End</td>
          <td class="text-center">
            <span v-if="match.score_breakdown.red.endgameRobot3 != 'None'">
              {{ match.score_breakdown.red.endgameRobot3 }} (+{{
                endgamePointMap[match.score_breakdown.red.endgameRobot3]
              }})
            </span>
            <v-icon v-else>mdi-close</v-icon>
          </td>
          <td class="text-center">
            <span v-if="match.score_breakdown.blue.endgameRobot3 != 'None'">
              {{ match.score_breakdown.blue.endgameRobot3 }} (+{{
                endgamePointMap[match.score_breakdown.blue.endgameRobot3]
              }})
            </span>
            <v-icon v-else>mdi-close</v-icon>
          </td>
        ...
        <tr>
          ...
          <td class="text-center">
            <v-icon>{{
              match.score_breakdown.red.cargoBonusRankingPoint
                ? "mdi-check"
                : "mdi-close"
            }}</v-icon
            ><span v-if="match.score_breakdown.red.cargoBonusRankingPoint"
              >(+1 RP)</span
            >
          </td>
          <td class="text-center">
            <v-icon>{{
              match.score_breakdown.blue.cargoBonusRankingPoint
                ? "mdi-check"
                : "mdi-close"
            }}</v-icon
            ><span v-if="match.score_breakdown.blue.cargoBonusRankingPoint"
              >(+1 RP)</span
            >
          </td>
        </tr>
        <tr>
          ...
          <td class="text-center">
            <v-icon>{{
              match.score_breakdown.red.hangarBonusRankingPoint
                ? "mdi-check"
                : "mdi-close"
            }}</v-icon
            ><span v-if="match.score_breakdown.red.hangarBonusRankingPoint"
              >(+1 RP)</span
            >
          </td>
          <td class="text-center">
            <v-icon>{{
              match.score_breakdown.blue.hangarBonusRankingPoint
                ? "mdi-check"
                : "mdi-close"
            }}</v-icon
            ><span v-if="match.score_breakdown.blue.hangarBonusRankingPoint"
              >(+1 RP)</span
            >
          </td>
        </tr>
        <tr>
          ...
          <td class="text-center">
            +{{ match.score_breakdown.blue.foulCount * 4 }} / +{{
              match.score_breakdown.blue.techFoulCount * 8
            }}
          </td>
          <td class="text-center">
            +{{ match.score_breakdown.red.foulCount * 4 }} / +{{
              match.score_breakdown.red.techFoulCount * 8
            }}
          </td>
        </tr>
        <tr>
