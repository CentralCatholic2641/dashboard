<template>
  <div>
    ...
    <v-card-text class="grey--text">
      ...
      <v-row>
        ...
        <v-col cols="4">
          <v-btn
            block
            :color="type == 'folder' ? 'primary' : 'grey'"
            :outlined="type != 'folder'"
            class="mb-4"
            large
            @click="type = 'folder'"
            >Folder</v-btn
    ...
    <v-card-actions>
      ...
      <v-spacer></v-spacer>
      <v-btn color="primary" @click="createResource()" :disabled="cantCreate"
