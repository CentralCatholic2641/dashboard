  ...
  <div>
          ...
          <v-col cols="12" md="4">
            <v-card class="mb-6">
              <v-card-text>
                <div class="mr-5">
                  <h3
                    :class="getClass($root.config.status || 'Active')"
            ...
            <v-card class="mb-6">
              ...
              <v-card-text>
                ...
                <v-btn class="mt-5" @click="clearCache()" text
            ...
            <v-card class="mb-6">
              ...
              <v-card-text>
                ...
                <v-switch
                  ...
                  color="primary"
                  @change="changes = true"
                  :disabled="!$root.config.currentEvent"
                ></v-switch>
    ...
    <v-dialog v-model="update_progress" max-width="500" persistent>
      <v-card>
        ...
        <v-card-text
          >This page will automatically reload upon completion.</v-card-text
        >
...
export default {
  ...
  methods: {
    ...
    checkForUpdates() {
      this.$http
        .get("https://update.aidanliddy.com/ver/tms/v1")
        .then((response) => {
